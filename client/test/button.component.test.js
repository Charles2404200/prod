...
// mocking them avoids side effects and keeps unit tests focused.
...
describe('Button — unit (render / interaction / branches)', () => {
  it('renders a <button> element', () => {
    ...
    // NOTE: your Button does not expose an accessible name from children by default.
    // We only assert the element role here.
